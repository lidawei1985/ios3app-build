...
public enum DefaultSites {
    ...
    public static let builtinRepos: [TVBoxSubscription] = [
        TVBoxSubscription(name: "直连精选 · 免引擎17站", url: "bundle:builtin_curated"),
        TVBoxSubscription(name: "高天流云 · 298站", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/js.json"),
        TVBoxSubscription(name: "业余打发 · 193站", url: "https://ghproxy.net/https://raw.githubusercontent.com/yydfys/yydf/main/yydf/yydfjk.json"),
        TVBoxSubscription(name: "心魔线路 · 151站", url: "https://ghproxy.net/https://raw.githubusercontent.com/yw88075/tvbox/main/yw.json"),
        TVBoxSubscription(name: "软件哥哥 · 136站", url: "http://47.96.82.41:8/api.json"),
        TVBoxSubscription(name: "高天流云0825 · 135站", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/0825.json"),
        TVBoxSubscription(name: "摸鱼线路 · 107站", url: "https://play.iptv365.org/%E6%91%B8%E9%B1%BC%E5%84%BF/api.json"),
        TVBoxSubscription(name: "菜妮丝 · 104站", url: "https://play.iptv365.org/%E8%8F%9C%E5%A6%AE%E4%B8%9D/api.json"),
        TVBoxSubscription(name: "newwex · 96站", url: "https://9280.kstore.vip/newwex.json"),
        TVBoxSubscription(name: "神仙线路 · 94站", url: "http://xhztv.top/dc/%E7%A5%9E%E4%BB%99/api.json"),
        TVBoxSubscription(name: "宝盒PG · 85站", url: "http://ygbhbox.3vfree.club/pg/jsm.json"),
        TVBoxSubscription(name: "WZ南风3 · 78站", url: "https://play.iptv365.org/%E5%8D%97%E9%A3%8E/api.json"),
        TVBoxSubscription(name: "OK杰克 · 76站", url: "https://play.iptv365.org/OK/api.json"),
        TVBoxSubscription(name: "南风线路 · 64站", url: "https://gitlab.com/noimank/tvbox/-/raw/main/tvbox1.json"),
        TVBoxSubscription(name: "肥猫线路 · 61站", url: "https://play.iptv365.org/%E8%82%A5%E7%8C%AB/api.json"),
        TVBoxSubscription(name: "高天流云0821 · 86站", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/0821.json"),
        TVBoxSubscription(name: "菜妮线路 · 55站", url: "http://liucn.cc/box/dc/lns/lns.json"),
        TVBoxSubscription(name: "高天流云0826 · 51站", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/0826.json"),
        TVBoxSubscription(name: "dxawi老牌 · 48站", url: "https://dxawi.github.io/0/0.json"),
        TVBoxSubscription(name: "挺好接口 · 46站", url: "http://ztha.top/TVBox/thdjk.json"),
        TVBoxSubscription(name: "小米线路 · 36站", url: "https://play.iptv365.org/%E5%B0%8F%E7%B1%B3/api.json"),
        TVBoxSubscription(name: "WZ短剧频道 · 35站", url: "http://box.ufuzi.com/tv/qq/%E7%9F%AD%E5%89%A7%E9%A2%91%E9%81%93/api.json"),
        TVBoxSubscription(name: "高天流云0827 · 33站", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/0827.json"),
        TVBoxSubscription(name: "动漫城 · 27站", url: "https://www.yingm.cc/dm/dm.json"),
        TVBoxSubscription(name: "俊哥98 · 24站", url: "http://home.jundie.top:81/top98.json"),
        TVBoxSubscription(name: "网盘4K · 4站", url: "https://gitlab.com/dokiss1/tvbox/-/raw/master/doki-Dx.json"),
        TVBoxSubscription(name: "高天流云0707 · 多仓", url: "https://cdn.jsdelivr.net/gh/gaotianliuyun/gao@master/0707.json"),
    ]
    ...
    public static let builtinAdultRepos: [TVBoxSubscription] = [
        TVBoxSubscription(name: "索倪精选 · 直连17站", url: "bundle:builtin_adult_curated"),
        TVBoxSubscription(name: "tjyu010 · 115站", url: "https://ghproxy.net/https://raw.githubusercontent.com/tjyu010/tvbox/main/cr1.json"),
        TVBoxSubscription(name: "fanfu0 · 114站", url: "https://ghproxy.net/https://raw.githubusercontent.com/fanfu0/mov/main/json/mov.json"),
        TVBoxSubscription(name: "zyscdx9 · 67站", url: "https://ghproxy.net/https://raw.githubusercontent.com/zyscdx/tvbox/main/9.txt"),
        TVBoxSubscription(name: "扛把子线路 · 43站", url: "https://ghproxy.net/https://raw.githubusercontent.com/felixiao/TVBoxSource/main/18/%E6%89%9B%E6%8A%8A%E5%AD%90%E7%BA%BF%E8%B7%AF.json"),
        TVBoxSubscription(name: "bluefriend · 29站", url: "https://ghproxy.net/https://raw.githubusercontent.com/bluefriendCN/set/main/ma.json"),
        TVBoxSubscription(name: "zyscdx3 · 33站", url: "https://ghproxy.net/https://raw.githubusercontent.com/zyscdx/tvbox/main/3.txt"),
        TVBoxSubscription(name: "zeee-u · 24站", url: "https://ghproxy.net/https://raw.githubusercontent.com/zeee-u/lzh06/main/video.json"),
        TVBoxSubscription(name: "wanjune3721 · 23站", url: "https://ghproxy.net/https://raw.githubusercontent.com/wanjune/wanjune.github.io/main/static/tvbox/3721.json"),
        TVBoxSubscription(name: "fhqeeqzp · 18站", url: "https://ghproxy.net/https://raw.githubusercontent.com/fhqeeqzp/tvbox/main/1111.json"),
        TVBoxSubscription(name: "浮力yyfxz1 · 17站", url: "https://ghproxy.net/https://raw.githubusercontent.com/yotudo/tvbox/main/TVBoxSource-main/18/%E6%B5%AE%E5%8A%9Byyfxz1.json"),
        TVBoxSubscription(name: "小武哥 · 12站", url: "https://ghproxy.net/https://raw.githubusercontent.com/wwb521/live/main/video.json"),
        TVBoxSubscription(name: "娱乐影院05 · 12站", url: "https://ghproxy.net/https://raw.githubusercontent.com/guxiangbin/tvbox2/main/%E5%A8%B1%E4%B9%90%E5%BD%B1%E9%99%A205.txt"),
        TVBoxSubscription(name: "Supprise0901 · 12站", url: "https://ghproxy.net/https://raw.githubusercontent.com/Supprise0901/Fetch/main/single_lines/adult18.json"),
    ]
